...
/**
 * Hourly + daily forecast for the supplied coordinates. Half of BE's
 * 10-min cache TTL by default so the UI stays well within fresh-data
 * window without thrashing.
 */
