...
/**
 * Radar tile config — proxied OWM. BE returns a `refreshIntervalSec`
 * indicating when the `timestamps.{now,forecastPlusOne}` rotate; mirror
 * that as `refetchInterval` so the FE picks up new tiles automatically.
 */
